import styles from "../../styles/CategoryComponents/CategoryDelete.module.scss";
import Title from "../Titles/Titles";
import { queryClient } from "../../constants/config";
import { useState } from "react";
import { useCategoriesGet, useCategoryDelete } from "../../queries/categories";
		...
		<div className={styles.categoryContainer}>
			...
			!ctgsRefetching ? (
				<form onSubmit={(e) => e.preventDefault()}>
					...
					>
						{ctgs?.data?.ctgs?.map((category: any, index: any) => {
							return (
